...
const AUDIT_ACTIONS = [
    ...
    'option_group.created'    => 'Added an option group',
    'option_group.updated'    => 'Edited an option group',
    'option_group.deleted'    => 'Removed an option group',
    'option_group.products'   => 'Changed which drinks offer an option group',
    'option.created'          => 'Added a customisation choice',
    'option.updated'          => 'Edited a customisation choice',
    'option.deleted'          => 'Removed a customisation choice',
